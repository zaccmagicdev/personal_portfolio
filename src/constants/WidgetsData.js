...
export const widgetData = [
    {
        ...
        id_name: 'codecracker',
        name: 'CodeCracker',
        githublink: 'https://github.com/zaccmagicdev/se_code_cracker_frontend',
        gifURL: 'https://media.tenor.com/JVn1Ve5xIbwAAAAM/ready-set.gif',
        description: 'This is a react version of the game Mastermind which is originally from Israel. See if you can get the code right in a certain amout of guesses'
    },
    {
        id: 1,
        id_name: 'calculator',
